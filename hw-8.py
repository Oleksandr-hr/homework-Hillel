...
names = ["boss", "mark", "jull", "olivia", "mery", "olifer"]
domains = [".ru", ".ua", ".net", ".com"]
my_list = ["asd", "qwe", "zxcv", "rty", "dfg", "hbvf", "polkf", "aslkf"]
my_list_1 = ["asd", 5, 5.11, "qwe", 6456, "poasd", (3, 1, "mik"), 23.40, "zcxzcads"]
my_str = "asdklasjdlkasd"
my_str_1 ="asdjklfdslkfjsdlkfjls!"
my_str_2 ="daffdsafadsf"
